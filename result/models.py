...
class Student(models.Model):
    ...
    local_govt_area = models.CharField(max_length=200, blank=True, null=True)
    Parent_name = models.CharField(max_length=300, blank=True, null=True)
    parent_address = models.CharField(max_length=200, blank=True, null=True)
    town = models.CharField(max_length=50, blank=True, null=True)
    country = CountryField()
    state = models.CharField(max_length=70)
    disabled = models.BooleanField(default=False)
    eye_problem = models.BooleanField(default=False)
    
    department = models.ForeignKey(Department, on_delete=models.CASCADE, default=1)
    faculty = models.ForeignKey(Faculty, on_delete=models.CASCADE, default=1)
   

    sex = models.CharField(max_length=10, default="Male", choices=GENDER)
...
class TakenCourse(models.Model):
    ...
    grade = models.CharField(choices=GRADE, max_length=3, blank=True)

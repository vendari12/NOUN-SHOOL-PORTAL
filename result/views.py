...
def CreateFacultyView(request):
    form = CreateFaculty()
    data = form.get_cleaned_data

    faculty = Faculty.objects.create(**data)
    faculty.save()
    return render (request, "registration/create_faculty.html", form=form)



def CreateDpartmentView(request):
    form = CreateDepartment()
    data = form.get_cleaned_data
    faculty = Department.objects.create(**data)
    faculty.save()
    return render (request, "registration/create_department.html", form=form)    
...
def ListDepartment(request):
    ...
    return render(request, 'faculty/department', context)
